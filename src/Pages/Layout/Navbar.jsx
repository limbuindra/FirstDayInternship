  ...
  return (
    <>
      <nav className="bg-white ">
        <div className="relative flex h-20 items-center justify-between px-6 lg:justify-between  lg:px-20 ">
          <div className="flex items-center text-xl space-x-2 lg:space-x-3 lg:text-4xl text-gray-800">
            <FaStar />
          ...
          <div className="hidden lg:flex items-center lg:text-xl lg:space-x-12">
            ...
            <div className="border p-2 lg:px-6 lg:py-4 rounded-lg">
